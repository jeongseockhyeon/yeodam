...
import static com.hifive.yeodam.orderdetail.domain.OrderDetailsStatus.PENDING;
...
public class OrderQueryService {
    ...
    private SliceImpl<AfterOrderResponse> getAfterOrderResponses(User user, Pageable afterPageable) {
        ...
        Slice<OrderDetail> afterPage = orderRepository
                .findOrderByDetailStatus(List.of(USED, OrderDetailsStatus.CANCELED), FAILED, user, afterPageable);
